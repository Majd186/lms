...
<html lang="ar">
  ...
  <meta name="description" content="ÇáãÊÌÑ ãÏÚæã ãä ØÑÝ ÈÑíÓÊÇÔæÈ">
...
@include('layouts.front.header-mobile')
@include('layouts.front.header-top')
@include('layouts.front.header-center')
@include('layouts.front.header-bottom')
        ...
        <div class="content-boxpage col">
            ...
            <div>
                <div id="_mobile_account_list">
                  <div class="account-list-content">
                                        <div>
                      <a class="login" href="http://demo.bestprestashoptheme.com/savemart/ar/ÇáÍÓÇÈ ÇáÔÎÕí" rel="nofollow" title="Log in to your customer account"><i class="fa fa-sign-in"></i>Sign in</a>
                    </div>
                    <div>
                      <a class="register" href="http://demo.bestprestashoptheme.com/savemart/ar/ÇáÍÓÇÈ ÇáÔÎÕí" rel="nofollow" title="Register Account"><i class="fa fa-user"></i>Register Account</a>
                    </div>
                                        <div>
                      <a class="check-out" href="http://demo.bestprestashoptheme.com/savemart/ar/ØáÈ ÔÑÇÁ" rel="nofollow" title="Checkout"><i class="material-icons">check_circle</i>Checkout</a>
                    </div>
          ...
          <div id="box-currency" class="box-content d-flex">
            <div class="w-100">
                ...
                <a title="Ìäíå ÅÓÊÑáíäí" rel="nofollow" href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=1">Ìäíå ÅÓÊÑáíäí: GBP</a>
              </div>
                          <div class="item-currency">
                <a title="ÏæáÇÑ ÃãÑíßí" rel="nofollow" href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=2">ÏæáÇÑ ÃãÑíßí: USD</a>
              </div>
                        </div>
          </div>
          ...
          <div id="box-language" class="box-content d-flex">
            <div class="w-100">
                ...
                <a href="http://demo.bestprestashoptheme.com/savemart/fr/?home=home_3&SubmitCurrency=1&id_currency=1" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/2.jpg" alt="Français (French)" width="16" height="11" /><span>Français</span></a>
                          ...
                          <div class="item-language">
                <a href="http://demo.bestprestashoptheme.com/savemart/es/?home=home_3&SubmitCurrency=1&id_currency=1" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/3.jpg" alt="Espa?ol (Spanish)" width="16" height="11" /><span>Espa?ol</span></a>
              </div>
                          <div class="item-language">
                ...
                <a href="http://demo.bestprestashoptheme.com/savemart/ar/?home=home_3&SubmitCurrency=1&id_currency=1" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/6.jpg" alt="ÇááÛÉ ÇáÚÑÈíÉ (Arabic)" width="16" height="11" /><span>ÇááÛÉ ÇáÚÑÈíÉ</span></a>
              </div>
                        </div>
          </div>
